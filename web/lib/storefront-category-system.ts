...
export const STOREFRONT_MAIN_CATEGORIES: StorefrontMainCategory[] = [
  {
    ...
    mascot: "pupuk",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.pupuk,
    imageAlt: "Karung pupuk berbagai jenis untuk kategori pupuk Wiragro.",
    accent: "#4d8f49",
    accentSoft: "#eef7d8",
    accentWarm: "#f8efe0",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "nutrisi",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.nutritionBooster,
    imageAlt: "Botol nutrisi tanaman dan booster untuk kategori nutrisi dan perangsang.",
    accent: "#2a8c76",
    accentSoft: "#ddf6ef",
    accentWarm: "#edf6e6",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "benih",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.benih,
    imageAlt: "Kemasan benih padi, jagung, dan cabai untuk kategori benih.",
    accent: "#8ab23b",
    accentSoft: "#f1f8d7",
    accentWarm: "#fbf4e2",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "bibit",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.bibit,
    imageAlt: "Bibit tanaman dalam polybag kecil untuk kategori bibit.",
    accent: "#5ba257",
    accentSoft: "#e6f6df",
    accentWarm: "#f7f0e0",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "pestisida",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.pesticide,
    imageAlt: "Botol pestisida dan alat semprot kecil untuk kategori pestisida.",
    accent: "#e06d41",
    accentSoft: "#ffe8db",
    accentWarm: "#f8efe5",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "tanah",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.soilAmendment,
    imageAlt: "Karung kapur pertanian dan dolomit untuk kategori pembenah tanah.",
    accent: "#8d6a3d",
    accentSoft: "#f7ead8",
    accentWarm: "#f8f0e5",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "media",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.soilAmendment,
    imageAlt: "Kemasan cocopeat, sekam bakar, dan media tanam untuk kategori media tanam.",
    accent: "#719251",
    accentSoft: "#eef5df",
    accentWarm: "#f8f1e2",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "persemaian",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.decorativeSeedling,
    imageAlt: "Tray semai, dome, dan pelet semai untuk kategori persemaian.",
    accent: "#54917f",
    accentSoft: "#e2f5ee",
    accentWarm: "#f5efe3",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "wadah",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.polybagContainer,
    imageAlt: "Polybag, pot plastik, dan grow bag untuk kategori polybag dan wadah tanam.",
    accent: "#4f7aab",
    accentSoft: "#e2eefb",
    accentWarm: "#f6eee0",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "alat",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.agriTools,
    imageAlt: "Sekop tangan, garpu, dan alat kecil kebun untuk kategori alat pertanian.",
    accent: "#4c7f59",
    accentSoft: "#e5f3e8",
    accentWarm: "#f7efe0",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "sprayer",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.sprayer,
    imageAlt: "Sprayer gendong dan sprayer tangan untuk kategori alat semprot.",
    accent: "#2f7c8a",
    accentSoft: "#dff5f7",
    accentWarm: "#f5efe2",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "irigasi",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.decorativeField,
    imageAlt: "Selang dan konektor pengairan untuk kategori irigasi dan pengairan.",
    accent: "#3279b6",
    accentSoft: "#dfeeff",
    accentWarm: "#f4efe5",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "mulsa",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.mulchProtector,
    imageAlt: "Mulsa plastik dan shade net untuk kategori mulsa dan pelindung tanam.",
    accent: "#6e8c45",
    accentSoft: "#edf5dd",
    accentWarm: "#f7efe0",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "panen",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.harvestTools,
    imageAlt: "Keranjang dan alat panen untuk kategori peralatan panen.",
    accent: "#b77237",
    accentSoft: "#fdecd9",
    accentWarm: "#f7efe2",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "kemasan",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.postHarvestPackaging,
    imageAlt: "Timbangan, karung, plastik, dan crate untuk kategori pascapanen dan kemasan.",
    accent: "#7d6a59",
    accentSoft: "#f2ebe4",
    accentWarm: "#fbf4e8",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "peternakan",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.livestock,
    imageAlt: "Pakan ternak, vitamin ternak, dan obat ternak untuk kategori peternakan.",
    accent: "#7f7d4c",
    accentSoft: "#f3f1d8",
    accentWarm: "#f8f0df",
    subcategories: [
  ...
  },
  {
    ...
    mascot: "kios",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.farmStoreNeeds,
  ...
  },
  {
    ...
    mascot: "layanan",
    imageSrc: WIRAGRO_CATEGORY_ASSETS.layanan,
    imageAlt: "Layanan pickup, delivery, dan pelacakan pesanan untuk kategori layanan.",
    accent: "#4d7a6c",
    accentSoft: "#e2f3ed",
    accentWarm: "#f7efe2",
    href: "/kontak",
